...
public class SearchAttributesConversionUtils
{
    ...
    private static SearchAttributes createSearchAttributes(Set<IElementAction> attributeTypes,
    ...
    private static Optional<IElementAction> findActionAttributeType(Set<IElementAction> types, String type)
    {
