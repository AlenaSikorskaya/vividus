...
public enum TestActionAttributeType implements IActionAttributeType
{
    ...
    TestActionAttributeType(String attributeName, Class<? extends IElementAction> actionClass)
    {
