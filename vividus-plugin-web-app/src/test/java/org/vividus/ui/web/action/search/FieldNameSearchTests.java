...
{
    @Spy private FieldNameSearch search;
    ...
    void testSearch()
    {
        ...
        doReturn(elements).when(search).findElements(searchContext, By.xpath(
    ...
    {
        assertEquals(ActionAttributeType.FIELD_NAME, search.getAttributeType());
    }
}
