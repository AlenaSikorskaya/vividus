...
{
    @Spy private CaseInsensitiveTextSearch search;
    ...
    void testSearch()
    {
        ...
        SearchParameters parameters = new SearchParameters("locator");

        doReturn(webElements).when(search).findElements(searchContext, By.xpath(
                ...
                + "\"locator\"] or @*[normalize-space(translate(., 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', "
                + "'abcdefghijklmnopqrstuvwxyz'))=\"locator\"] or *[normalize-space(translate(.,"
                + " 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'))=\"locator\"]])]"), parameters);
    ...
    {
        assertEquals(ActionAttributeType.CASE_INSENSITIVE_TEXT, search.getAttributeType());
    }
}
