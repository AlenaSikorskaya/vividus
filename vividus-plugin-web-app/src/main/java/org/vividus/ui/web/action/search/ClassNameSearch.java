...
public class ClassNameSearch extends AbstractElementSearchAction implements IElementSearchAction
{
    @Override
    public List<WebElement> search(SearchContext searchContext, SearchParameters parameters)
    {
        return findElements(searchContext, How.CLASS_NAME.buildBy(parameters.getValue()), parameters);
    }
